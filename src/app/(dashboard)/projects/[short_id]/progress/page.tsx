...
import { Plus, Trash2, FileText, Save, ArrowLeft, Activity, FileQuestion } from 'lucide-react'

export default function ProjectProgressPage() {
  const { project, language, projectLanguage, short_id } = useProjectDetailContext()
    ...
    <div className='space-y-6'>
      ...
      <div className='flex items-center justify-between gap-4'>
        <h2 className='text-lg font-bold text-foreground'>
          {selectedReportId ? 'Edit Laporan Kemajuan' : 'Manajemen Laporan Kuartalan & Progress'}
        </h2>
        {selectedReportId && (
              ...
              <Card className='p-6 space-y-6 animate-in fade-in duration-300'>
                ...
                {outcomeList.length === 0 ? (
                  <Alert type='warning' title='Outcome Kosong'>
                    ...
                    <strong>Plan (Rencana)</strong> terlebih dahulu.
                  </Alert>
                ) : (
                  <div className='space-y-6'>
                    {outcomeList.map(out => {
