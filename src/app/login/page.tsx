...
"use client" // Wajib ada karena kita menggunakan aksi onClick (interaksi user)
    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      ...
      <Card className="w-full max-w-md rounded-3xl border-border/50 bg-surface/50 shadow-xl">
        <CardHeader className="text-center space-y-2 pt-10">
          ...
          <CardTitle className="text-3xl">OSD Projects</CardTitle>
        ...
        <CardContent className="pb-10">
          ...
          >
            ...
            <span className="font-semibold">{isLoading ? 'Memproses...' : 'Login dengan Google'}</span>
          </Button>
        </CardContent>
      </Card>
    </div>
